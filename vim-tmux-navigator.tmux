...
tmux bind-key -r -T prefix 'C-Left' if-shell "$is_vim" 'send-keys " wmh"' ''
tmux bind-key -r -T prefix 'C-Right' if-shell "$is_vim" 'send-keys " wml"' ''
tmux bind-key -r -T prefix 'C-Down' if-shell "$is_vim" 'send-keys " wmj"' ''
tmux bind-key -r -T prefix 'C-Up' if-shell "$is_vim" 'send-keys " wmk"' ''
